...
async function generateAPIIndices() {
  ...
  var quaverAPIPL = await fetch("https://api.quavergame.com/v1/users/full/170");
  ...
  var quaverAPICZ = await fetch("https://api.quavergame.com/v1/users/full/206601");
  ...
  var quaverScores = await fetch("https://api.quavergame.com/v1/users/scores/recent?id=108492&mode=1");
  ...
  var mspfaInfo = await fetch("https://mspfa.com/", {
  ...
  var mspfaStories = await fetch("https://mspfa.com/", {
